...
- Read `docs/specs/$1/spec.json` for metadata and phase status
...
**Spec Not Found**:
- **Message**: "No spec found for `$1`. Check available specs in `docs/specs/`"
...
- Shows all specs in `docs/specs/` with their status
